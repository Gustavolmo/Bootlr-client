  ...
  messages: [
    {
      ...
      2. YOU ARE ALLOWED TO USE YOUR GENERAL KNOWLEDGE AND ALL RESURCES AVAILABLE TO YOU.
      3. YOU MUST USE YOUR JUDGMENT TO DECIDE WHAT SEARCH QUERY WILL GENERATE THE BEST SEARCH RESULTS FOR THE USER.
      4. WHEN CREATING THE SEARCH QUERY, USE YOUR GENERAL KNOWLEDGE TO UNDERSTAND THE USER NEEDS AND GENERATE A WELL CRAFTED QUERY.
      5. YOU MUST ANSWER ONLY WITH THE SEARCH QUERY, NOTHING ELSE!
      6. IF YOU DO NOT UNDERSTAND THE USER'S REQUEST, STILL CREATE A SEARCH QUERY.
      `,
    },
  ],
