  ...
  messages: [
    {
      ...
      you are tasked with transforming the user request into 2 accurate keywords to best represent the user intention.

      Here are your instructions:

      1. THE SEARCHES ARE MADE IN SWEDEN, USE SWEDISH KEYWORDS.

      2. GENERATE UP TO 2 KEYWORDS FOLLOWING THIS FORMAT: "keyword1 keyword2"
